...
func InitializeApp() (*gin.Engine, error) {
	...
	authConn, err := grpc.Dial("zog-authsvc:5050", grpc.WithInsecure())
	if err != nil {
		return nil, err
	}
	...
	// Service2
	adminDashboardConn, err := grpc.Dial("zog-adminsvc:5051", grpc.WithInsecure())
	if err != nil {
		return nil, err
	}
	...
	// Service3
	userDashboardConn, err := grpc.Dial("zog-usersvc:5052", grpc.WithInsecure())
	if err != nil {
		return nil, err
	}
	...
	// Service4
	orderConn, err := grpc.Dial("zog-ordersvc:5053", grpc.WithInsecure())
	if err != nil {
		return nil, err
	}
